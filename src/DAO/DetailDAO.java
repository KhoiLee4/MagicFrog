...
public class DetailDAO implements DAOInterface<Detail> {
    ...
    public int insert(Detail t) {
        ...
        try {
            ...
            String sql = "INSERT INTO detail(username, money, max_score, game_music, sound_effect)"
                    + " values (?, ?, ?, ?, ?);";
            ...
            st.setBoolean(4, t.isGameMusic());
            st.setBoolean(5, t.isSoundEffect());
    ...
    public int update(Detail t) {
        ...
        try {
            Connection con = JDBCUtil.getConnection();
            String sql = "UPDATE detail SET money = ?, max_score = ?, game_music = ?, sound_effect = ? WHERE username = ?";
            PreparedStatement st = con.prepareStatement(sql);

            st.setInt(1, t.getMoney());
            st.setInt(2, t.getMaxScore());
            st.setBoolean(3, t.isGameMusic());
            st.setBoolean(4, t.isSoundEffect());
